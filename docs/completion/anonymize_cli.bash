...
_anonymize_cli_complete() {
    ...
    if [[ "$cur" == -* ]]; then
        suggestions="$suggestions --dry-run --help --output --profile --source --verbose -h"
    fi
...
complete -F _anonymize_cli_complete anonymize_cli
