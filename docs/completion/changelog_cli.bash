...
_changelog_cli_complete() {
    ...
    if [[ "$cur" == -* ]]; then
        suggestions="$suggestions --group-by --help --limit --out --print --since --title --until -h"
    fi
...
complete -F _changelog_cli_complete changelog_cli
