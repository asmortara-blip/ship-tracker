...
_db_check_cli_complete() {
    ...
    if [[ "$cur" == -* ]]; then
        suggestions="$suggestions --db --fix --full --help --json -h"
    fi
...
complete -F _db_check_cli_complete db_check_cli
