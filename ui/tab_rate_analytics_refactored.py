...
Canonical reference implementation that uses the shared WSJ design system
in ``ui/styles.py`` instead of redeclaring colors and inlining HTML. Compare
against ``tab_rate_analytics.py`` for the "before" version.
